...
class Transformer(nn.Module):
    ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Optional[Tensor] = None, tgt_mask: Optional[Tensor] = None,
        ...
        memory, encoder_atten_weights = self.encoder(src, mask=src_mask, src_key_padding_mask=src_key_padding_mask)
        output,decoder_atten_weights = self.decoder(tgt, memory, tgt_mask=tgt_mask, memory_mask=memory_mask,
                              tgt_key_padding_mask=tgt_key_padding_mask,
                              memory_key_padding_mask=memory_key_padding_mask)
        return output, encoder_atten_weights, decoder_atten_weights
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, src: Tensor, mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None) -> Tensor:
        ...
        for mod in self.layers:
            output, atten_weights = mod(output, src_mask=mask, src_key_padding_mask=src_key_padding_mask)
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
        ...
        for mod in self.layers:
            output, atten_weights = mod(output, memory, tgt_mask=tgt_mask,
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None, src_key_padding_mask: Optional[Tensor] = None) -> Tensor:
        ...
        src2, atten_weights = self.self_attn(src, src, src, attn_mask=src_mask,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None, memory_mask: Optional[Tensor] = None,
        ...
        tgt2, atten_weights = self.multihead_attn(tgt, memory, memory, attn_mask=memory_mask,
...
def multi_head_attention_forward(query: Tensor,
    ...
    if attn_mask is not None:
        if attn_mask.dtype == torch.bool:
            ...
            #attn_output_weights.masked_fill_(attn_mask, float('0'))
        else:
