...
#export SINGULARITY_BINDPATH=/groups/gac50631 #Before
...
#cd /home/aac13109bi/target-driven-navigation-based-on-transformer
...
#singularity exec --nv /home/aac13109bi/target-driven-navigation-based-on-transformer/cenotate_transformer.simg python -u eval.py
#python -u eval.py #sub
