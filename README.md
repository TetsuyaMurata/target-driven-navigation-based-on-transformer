...
### Calculation
to caluculate agent's average score by FloorPlan from a log file after evaluation on the condition of having a lot of log files, you can use `category_score_mean.py`.
