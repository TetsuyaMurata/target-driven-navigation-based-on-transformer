...
If you would adopt method of 'grid_memory' to reproduce `Object Memory Transformer`, you cau run `create_experiment.py` like below. You will get a param.json with the agent's training and evaluation requirements in the target folder of EXPERIMENT.
