...
These scripts have been implemented and tested on "Ubuntu 18.04, python 3.6, PyTorch 1.10.1 and CUDA 10.1", "Windows by using Ubuntu 18.04 WSL , python 3.6, PyTorch 1.10.1 and CUDA 9.1.85"
...
If you want to execute `create_dataset.py` on Windows, you need to prepare Ubuntu with WSL.
