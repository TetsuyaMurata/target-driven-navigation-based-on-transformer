...
These scripts have been implemented and tested on "Ubuntu 18.04, python 3.6, PyTorch 1.10.1 and CUDA 10.1", "Windows by using Ubuntu 18.04 WSL(Windows Subsystem for Linux) , python 3.6, PyTorch 1.10.1 and CUDA 9.1.85"
