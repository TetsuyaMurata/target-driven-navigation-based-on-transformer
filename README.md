...
- `python sixaxis_explore.py -e ./EXPERIMENT/grid_memory/param.json` (GameController) or `python sixaxis_explore.py -e ./EXPERIMENT/grid_memory/param.json -s FloorPlan3 -o Bowl`
