...
# os.chdir('/home/dl-box/target-driven-navigation-based-on-transformer/model/Transformer_word2vec/80scene/45deg/1layer/grid_memory/50cm/seed/4hist/61/concat/first') #test
# os.chdir('./model/Transformer_word2vec/80scene/45deg/1layer/grid_memory/50cm/seed/32hist/61') #origin
# os.chdir('/home/dl-box/target-driven-navigation-based-on-transformer/model/Transformer_word2vec/80scene/45deg/1layer/grid_memory/50cm/seed/4hist/61/concat/local_untrained/local/8action_45degree/untrained/eval') #origin
